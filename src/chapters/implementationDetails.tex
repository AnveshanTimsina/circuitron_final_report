...
The algorithm evaluates all three possible pairings of the four neighbors and selects the one that minimizes the sum of dot products, ensuring paired neighbors are maximally opposite. The threshold of $-0.7$ (corresponding to approximately $45^\circ$ from direct opposition) validates that the pairing represents a genuine crossing geometry. Crossover nodes that fail validation (fewer than 4 neighbors or non-opposing geometry) are retained as regular junctions.
