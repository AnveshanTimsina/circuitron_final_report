...
\begin{itemize}
    ...
    \item \textbf{Lightweight prototyping:} The project enables rapid comparison of hand-drawn designs with \gls{spice} simulation results early in the design process for quick feedback and validation.
