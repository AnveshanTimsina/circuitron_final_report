...
The frontend system has been realized using React.js, CircuitJS and relevant packages like react-draggable and KiCad Symbol Library. Likewise, the backend of the circuitron system exposes a \gls{rest} \gls{api} that manages the complete lifecycle of circuit simulations. The \gls{api} provides endpoints for submitting CircuitJS-compatible text files, validating circuit syntax, and executing simulations using different analysis modes such as transient, \gls{ac}, and \gls{dc} analysis. 
