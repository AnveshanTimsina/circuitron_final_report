...
\begin{itemize}
    ...
    \item \textbf{FastAPI:} FastAPI is a modern, high-performance \gls{python} web framework used for building \gls{rest} \glspl{api}. It is designed for rapid development, high execution speed, and automatic generation of interactive \gls{api} documentation. In this project, FastAPI is used to implement the backend services that handle requests from the frontend, manage data exchange, and interface with the text recognition and analysis modules. Its native support for asynchronous operations and integration with Pydantic ensures efficient request handling and data validation.
