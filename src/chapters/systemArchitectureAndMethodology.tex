...
This work presents a pipeline for detecting lines in skeletonized circuit images by identifying endpoints and constructing a graph representation using a Multi-Head Breadth-First Search (BFS) algorithm. The methodology consists of two primary stages: endpoint detection from object detection bounding boxes, and graph construction via skeleton traversal.
