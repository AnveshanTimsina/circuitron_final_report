...
\renewcommand\cSubmittedIRoll{(48905)}
\renewcommand\cSubmittedIIRoll{(48931)}
\renewcommand\cSubmittedIIIRoll{(48936)}
\renewcommand\cSubmittedIVRoll{(48942)}  % Leave empty for 3 authors, or add 4th roll number
...
\newcommand\cExternalExaminer{Er. Deepesh Prakash Guragain}
\newcommand\cExternalExaminerTitle{External Examiner}
\newcommand\cExternalExaminerDept{Department of Electronics and Communications Engineering}
\newcommand\cExternalExaminerAddress{Nepal Engineering College}


% Date Formats
\newcommand\cDate{March 2026}
\newcommand\cDateFull{March 23, 2026}
