...
This project includes two separate OCR models for character recognition, the second one being TrOCR (TrOCR-base to be exact) developed by Microsoft, specifically for handwritten text. 
...
The netlist serves as input to a circuit simulation engine, which then performs numerical computations to evaluate how the circuit behaves under specified conditions.
