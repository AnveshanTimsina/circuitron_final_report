...
Figure \ref{fig:yolov7-architecture} shows the three primary modules of YOLOv7 architecture: Backbone, Neck, and Head.
...
From the individual outputs from each of the aforementioned modules, the task is now to generate a structured \gls{json} representation of the circuit which will be used to generate a corresponding CircuitJS-compatible text file and also contribute in the schematic generation further down the line.
